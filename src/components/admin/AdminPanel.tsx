...
import { EventItem } from '../../context/DataContext';
...
/**
 * Native window.fetch wrapper to prevent recursive self-calling or stack overflows
 */
...
interface CreateNewEventSectionProps {
  onSuccess?: () => void;
  setTab?: (tab: any) => void;
}
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(360px, 1fr))', gap: 28, alignItems: 'start' }}>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
            ...
            <div
              style={{
                ...
                border: '1px solid',
                borderColor: form.isUpcoming ? 'rgba(16, 185, 129, 0.3)' : 'var(--adm-border)',
                borderRadius: 12,
                padding: '16px 18px',
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                <div>
                  <div style={{ fontWeight: 700, fontSize: 14, color: form.isUpcoming ? '#34d399' : 'var(--adm-text-main)' }}>
        ...
        <div style={{ position: 'sticky', top: 90 }}>
          <div style={{ marginBottom: 12, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <span style={{ fontSize: 12, fontWeight: 700, color: 'var(--adm-text-dim)', textTransform: 'uppercase', letterSpacing: '0.06em' }}>
              👁️ Real-Time Website Card Preview
            </span>
            <span style={{ fontSize: 11, color: 'var(--adm-text-dim)' }}>Updates as you type</span>
          </div>
          ...
          <div
            ...
            style={{
              ...
              border: form.isUpcoming ? '1px solid rgba(16, 185, 129, 0.4)' : '1px solid var(--border-medium)',
              borderRadius: 18,
          ...
          >
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 14 }}>
              <span className={`pill-badge ${form.badge_class}`} style={{ fontSize: 11 }}>
                {form.badge || 'WORKSHOP'}
              </span>
            ...
            {/* Schedule & Date */}
            <div style={{ color: 'var(--accent-cyan)', fontSize: 13, fontWeight: 600, marginBottom: 8, display: 'flex', alignItems: 'center', gap: 6 }}>
              <span>📅 {form.date || 'Date TBD'}</span>
              {form.time && <span style={{ color: 'var(--text-muted)' }}>• 🕒 {form.time}</span>}
            </div>
...
export default CreateNewEventSection;
